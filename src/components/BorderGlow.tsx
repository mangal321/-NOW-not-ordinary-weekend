...
/**
 * BorderGlow — cursor-tracking gradient border + glow card (React Bits).
 * Full interactive experience on web; renders as a normal bordered card on native.
 */
...
export default function BorderGlow({
  ...
  const edgeBorder = lightSurface ? "rgb(24 24 27 / 12%)" : "rgb(255 255 255 / 15%)";
  ...
  const conicBorderMask = `conic-gradient(from ${angleDeg} at center, black ${coneSpread}%, transparent ${coneSpread + 15}%, transparent ${100 - coneSpread - 15}%, black ${100 - coneSpread}%)`;
  const fillMasks = [
    ...
    >
      ...
      <div
        style={{
          ...
          maskImage: conicBorderMask,
          WebkitMaskImage: conicBorderMask,
          transition: fade,
        }}
      />
      ...
      <div
        style={{
          ...
          maskImage: fillMasks.join(", "),
          WebkitMaskImage: fillMasks.join(", "),
